...
import {Paper, CardHeader, CardContent, Card} from "@material-ui/core";
import {
...
import ChartHeader from '../../containers/TempLineChart/ChartHeader/ChartHeader';
...
export default class TempLineChart extends React.PureComponent {
    constructor(props) {
        super(props);
        ...
        return (
            <Paper>
                <Card style={{ backgroundColor: '#252c36' }}>
                    <CardHeader title="chart-header" component={() => <ChartHeader />}>

                    </CardHeader>
                    <CardContent>
                        <Chart data={chartData} style={{ width: '100vh' }}>
